...
<div id="menu">
	<ul>
		...
		<li><a href="<%= response.encodeUrl(request.getContextPath() + "/Controller?action=createcustomer") %>" id="menu4" accesskey="4" title="">Register (Customer)</a></li>
	</ul>
</div>
<br><br><br><br>
<div id="content">
	<div id="colA">
		<div id="welcome" class="boxedA">
			...
			<form method="post" action="<%=response.encodeUrl(request.getContextPath()
					+ "/Controller?action=customerlogin")%>">
			<table>
				  <tr>
